...
import { fetch } from '../../actions/users/actions';
import { selectUsers, selectIsLoading, selectIsFetched } from '../../selectors/selectors';
import { User } from '../../actions/users/model';
    ...
    return (
      <Container>
        ...
        <List>
          {users.map((item, idx) => {
            return (
              <Card key={idx} title={item.nm} label={item.pp}/>
            );
          })}
        </List>
